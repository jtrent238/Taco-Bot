...
class BotInfo:
    ...
    def join_message(self):
        ret = bold("Hey there!") + "\n"
        ret += "I'm Taco and I just got asked to join this server.\n"
    ...
    async def support(self):
        ...
        await self.bot.say("If you'd like to support continued bot and cog "
                           ...
                           "Patreon: https://www.patreon.com/jtrent238")

    @commands.command()
    async def botinfo(self):
        """General bot information"""
        await self.bot.say("I'm Taco, a general, multi-purpose bot that is"
                           " always getting new features. You can access my"
                           " new support server here"
                           " (http://discord.me/jtrent238). All of my"
                           " help documentation can be found by using `T!help`"
                           " so feel free to mess around with commands to"
                           " find what you like! If you'd like to support"
                           " continued development, check out `T!support`")
